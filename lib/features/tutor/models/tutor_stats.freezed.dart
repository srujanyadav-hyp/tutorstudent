...
class _$TutorStatsImpl implements _TutorStats {
  ...
  @override
  String toString() {
    return 'TutorStats(totalSessions: $totalSessions, totalEarnings: $totalEarnings, upcomingSessions: $upcomingSessions, totalStudents: $totalStudents, monthlyEarnings: $monthlyEarnings, averageRating: $averageRating, totalReviews: $totalReviews, sessionsPerDay: $sessionsPerDay, sessionMetrics: $sessionMetrics, earningMetrics: $earningMetrics)';
  }
